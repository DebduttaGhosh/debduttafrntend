    ...
    for (i = 0; i < students.length; i++) {
        if (searched.value.toLowerCase() == students[i].name.toLowerCase()) {
            ...
            Swal.fire({
                ...
                text: ` S1: ${students[i].s1} | S2: ${students[i].s2} | S3: ${students[i].s3} | S4: ${students[i].s4} | Total: ${students[i].s1 + students[i].s2 + students[i].s3 + students[i].s4 + students[i].b} | Percentage: ${((students[i].s1 + students[i].s2 + students[i].s3 + students[i].s4 + students[i].b) * 100 / 70).toFixed(2)}%`,
                icon: 'success',
